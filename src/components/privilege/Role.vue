                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-button @click="handleClick(scope.$index, scope.row)" type="text" size="small">角色权限</el-button>
                        </template>
                    </el-table-column>
                    <el-table-column label="操作" width="150" v-if="(hasPermission('admin/role', 'update') || hasPermission('admin/role', 'delete'))">
                        <template slot-scope="scope">
                            <el-button
                                    size="mini"
                                    type="primary"
